              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-10 bg-background/60 focus:bg-background transition-colors ${currentPassword
                      ? 'border-input'
                      : ''
                      }`}
                    autoFocus
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-10 bg-background/60 focus:bg-background transition-colors ${confirmPassword && confirmPassword !== newPassword
